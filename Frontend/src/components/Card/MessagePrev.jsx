...
function MessagePrev({ chat, setSelectedUser, currentUser }) {
  ...
  return (
    <div>
      {chat.messages ? (
        <div
          onClick={() => setSelectedUser(chat.accB?._id === currentUser ? chat.accA : chat.accB)}
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1">
              <p className="font-semibold text-base">{chat.accB?._id === currentUser ? chat.accA?.user_name : chat.accB?.user_name}</p>
